...
export const ARTICLES = [
  // ------- FEATURED · BACHELOR TRIP (FIRST-PERSON ESSAY) -------
  {
    ...
    subtitle: "Twelve men. Four days. Two rounds at Solmar and Diamante Dunes. How this trip became the exact operational blueprint for Golf in México.",
    metaTitle: "Bachelor Golf Trip Cabo — Solmar & Diamante Dunes | Golf in México°",
    metaDescription: "A Tour agent's first-person account of a twelve-man bachelor golf trip to Cabo — Solmar Links and members-only Diamante Dunes — and how it sparked Golf in México.",
    excerpt: "Twelve men. Four days. Two rounds at Solmar and Diamante Dunes. How this trip became the exact operational blueprint for Golf in México.",
    ...
    body: [
      ...
      { type: "image", src: "/articles/bachelor-trip/02-solmar-dunes.jpg", caption: "Solmar Links · The dunes where Troy was filmed", alt: "Solmar Links green framed by massive Cabo sand dunes" },
      ...
      { type: "image", src: "/articles/bachelor-trip/05-diamante-tee.jpg", caption: "Diamante Dunes · Davis Love III · #1 in México per Golf Digest", alt: "Player teeing off at Diamante Dunes with sand dunes behind" },
      { type: "p", text: "The Dunes course sits on an entirely different tier. Golf Digest consistently ranks it as the number one course in México, and I would not argue the point. The links-style layout works with the natural topography in a way I had never experienced before. The higher-handicap players in my bachelor party preferred Solmar because it was more forgiving, but Diamante is a demanding, shot-maker's layout. For me, it is the most extraordinary golf course I have ever played in México." },
      ...
      { type: "image", src: "/articles/bachelor-trip/03-bagatelle.jpg", caption: "Bagatelle · Copper lamps over the tequila bar", alt: "Bagatelle bar in Cabo with copper hanging lights" },
      { type: "divider" },
      ...
      { type: "p", text: "Sitting around the table for our final dinner, the realization hit me. I had just successfully executed a bucket-list trip where my friends didn't break the bank to experience one of the best golf destinations in México. The reviews from the guys were ten out of ten. They were extremely happy. And for me, it unlocked exactly what I had been searching for: a way to stay within the golf industry and build a real business." },
