...
const CANCUN = {
  ...
  courses: [
    ...
    { tier: "public",  verified: true, fee: "$180",          name: "Riviera Cancun Golf Club", difficulty: "3/5", bestFor: "Pre-flight round · 10 min from CUN", specs: "Jack Nicklaus · Par 72 · 7,060 yards · 2009", photos: ["https://images.unsplash.com/photo-1592919505780-303950717480?auto=format&fit=crop&w=1600&q=85"],                     note: "A Jack Nicklaus design at 7,060 yards, carved using the terrain's natural contours, with ocean views throughout. Located near Cancun airport on the same property as El Tinto — but a separate, standalone Nicklaus championship layout. The pre-flight round on the corridor. Open 7:00am to 4:00pm. Transportation available from Hotel Zone.", standout: "#14 and #15 — the Nicklaus signature stretch. Two strategic risk-reward holes back-to-back along the natural ridgeline." },
    { tier: "public",  verified: true, fee: "$180",          name: "El Tinto",                difficulty: "3/5", bestFor: "Nick Price design · 10 min from CUN", specs: "Nick Price · Par 72 · 6,791 yards", photos: ["https://images.unsplash.com/photo-1593111774240-d529f12cf4bb?auto=format&fit=crop&w=1600&q=85"], note: "18 holes, par 72, 6,791 yards — designed by Nick Price, who took advantage of the area's abundant environmental resources. Sits on the same property as Riviera Cancun Golf Club but is its own standalone layout. The vertical movement and natural rockwork make it one of the more distinctive inland rounds in the region. Open 7:00am to 4:00pm. Transportation available from Hotel Zone.", standout: "The natural rock features integrated into the routing — limestone outcrops left in place as part of the course architecture rather than removed." },
