...
const UNIQUE = {
  ...
  overviewH2Pre: "The México",
  overviewH2Em: "you don't see on TV.",
  overviewParagraphs: [
    "México's golf identity is defined by the headline corridors: Cabo, Punta Mita, the Riviera Maya, Vallarta, CDMX. But the country carries another twelve-plus destinations outside those clusters — places locals play, places that don't appear in international magazines, places that require knowing somebody to book.",
    "This is the catalog of those rounds. They're not for the first trip. They matter by the fifth or seventh visit. Each one is worth a dedicated week of its own. The Travel Brief covers the access logic for each — the right relationship is more important than the right week.",
  ],
  overviewStats: [
    { num: "12+",      label: "Curated destinations" },
    { num: "Trip 5+",  label: "When these matter" },
    { num: "Local",    label: "Knowledge required" },
    { num: "1 / trip", label: "Pick one per visit" },
  ],

  playbookH3Pre: "Your free",
  playbookH3Em: "2026 Hidden Routings Travel Brief.",
  playbookBody: "The full Hidden México guide as a PDF. Twelve-plus lesser-known destinations worth flying for, what makes each one different, and how to actually book the round. Sent to your inbox in 60 seconds.",

  photoStrip: [
    { label: "Valle de Bravo · Lakeside" },
    { label: "San Miguel de Allende · Colonial highlands" },
    { label: "Loreto · Sea of Cortez" },
  ],

  coursesLabel: "The destinations",
  coursesH2Pre: "Twelve-plus places",
  coursesH2Em: "worth the detour.",
  coursesIntro: "A running list of the México golf destinations beyond the headline corridors — each one a full trip on its own.",
  isDestinationList: true,
  destinations: [
    { name: "San Miguel de Allende", region: "Guanajuato · Colonial highlands" },
    { name: "Mérida",                region: "Yucatán · Colonial Caribbean" },
    { name: "Loreto",                region: "Baja California Sur · Sea of Cortez" },
    { name: "Ciudad del Carmen",     region: "Campeche · Gulf coast" },
    { name: "Valle de Bravo",        region: "Estado de México · Lakeside highlands" },
    { name: "Mazatlán",              region: "Sinaloa · Pacific coast" },
    { name: "Querétaro",             region: "Querétaro · Bajío highlands" },
    { name: "Acapulco",              region: "Guerrero · Pacific coast" },
    { name: "Ixtapa · Zihuatanejo",  region: "Guerrero · Pacific coast" },
    { name: "Tequisquiapan",         region: "Querétaro · Wine country" },
    { name: "Tabasco",               region: "Tabasco · Gulf coast" },
    { name: "Hermosillo",            region: "Sonora · Northern desert" },
  ],
