...
const LOS_CABOS = {
  ...
  courses: [
    ...
    { tier: "private", verified: true, fee: "$315 – $385", name: "Cove Club at Cabo del Sol",    difficulty: "4/5", bestFor: "Iconic back nine, sea views",   specs: "Jack Nicklaus · Par 72 · Championship", photos: ["https://images.unsplash.com/photo-1518602164578-cd0074062767?auto=format&fit=crop&w=1600&q=85"],                  note: "The course that put Los Cabos on the global golf map. Reopened in 2019 as the Cove Club with redesigned holes by Nicklaus, including a new par-3 17th that drops to a green backdropped by the sea. Golf Digest World Top 100.",                                                                                                                                                                                                                            standout: "#18 — Peninsula-style green that appears to float on the ocean. The previous par-4 16th, remodeled as the closing hole, plunges 100 feet down the side of a mountain." },
    ...
    { tier: "public",  verified: true, fee: "$95 – $245",  name: "Palmilla Golf Club",            difficulty: "3/5", bestFor: "Three nines, historic",         specs: "Jack Nicklaus · Par 72 · 27 holes", photos: ["https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=1600&q=85"],                      note: "The course that started the modern corridor in 1992. Three interchangeable nines (Mountain, Arroyo, Ocean) — the first Jack Nicklaus Signature Design in Latin America. The Ocean nine, added in 1997, features a 600-foot elevation drop from tee to green. Golf Digest Top 10 in Mexico. Outside play season- and time-dependent; preferred rates for One&Only Palmilla guests.",                                                                                                                                                                                                                                                                                                                                                                       standout: "Ocean #3 — Par 4 dropping 150 feet to a beachfront green steps from the crashing Sea of Cortez. The most photographed hole at Palmilla." },
...
const PUNTA_MITA = {
  ...
  courses: [
    { tier: "resort",  verified: true, fee: "$345 – $395", name: "Pacifico Course",          difficulty: "4/5", bestFor: "The Tail of the Whale · ocean holes",  specs: "Jack Nicklaus · Par 72 · 7,014 yards · 1999", photos: ["https://images.unsplash.com/photo-1530549387789-4c1017266635?auto=format&fit=crop&w=1600&q=85"],  note: "380 acres of peninsula. Eight holes on the Pacific. One island green in the middle of the ocean. The 3B optional — Tail of the Whale — is reachable by boat at low tide only. It is the only natural island green in golf. Ask the pro shop the night before for the tide window. If your tee time falls inside it, go. If not, play 3A. The round holds either way. Caddie included from the shuttle to the final putt. Resort access only — Four Seasons, St. Regis, private residences.", standout: "3B — nothing else like it in golf." },
    { tier: "resort",  verified: true, fee: "$325 – $375", name: "Bahia Course",             difficulty: "3/5", bestFor: "Ocean-carry par 5 finish",            specs: "Jack Nicklaus · Par 72 · 2005", photos: ["https://images.unsplash.com/photo-1535131749006-b7f58c99034b?auto=format&fit=crop&w=1600&q=85"],               note: "Same peninsula. Same caddie. More forgiving off the tee. Bahia moves through tropical jungle before finding the ocean on the closing holes. The last shot of the round is a forced carry over water — the only ocean-carry par 5 in Mexico. You make the decision before you take the club back. Resort access only — Four Seasons, St. Regis, private residences.",                                                                                                                                                                  standout: "#18 — commit or lay up. The round ends with a choice." },
    { tier: "public",  verified: true, fee: "$250 – $280", name: "Mandarina Golf Club",      difficulty: "3/5", bestFor: "Short-course concept · no key needed", specs: "Greg Norman · 9 par 3s + 1 challenge hole", photos: ["https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1600&q=85"],    note: "Not a full 18. Nine par 3s, each with a name and a concept: The Redan, The Devil's Hole, The Queen, The Theater, The Bell. Plus one challenge hole — The Kraken — a near-island green with a pot bunker as the only escape. Norman: \"El campo de Mandarina no tendrá parangón.\" Fee includes two rounds of 10 holes, cart with GPS, unlimited practice, and all food and beverages. No membership required. Transportation to the property needed from outside the Mandarina community.",                                       standout: "The Theater — Norman described it as one of the best medium-distance par 3s in the world." },
