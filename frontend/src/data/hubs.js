...
const PUNTA_MITA = {
  ...
  quickFacts: [
    ...
    { icon: "dollar",    label: "Green fees",   value: "$150 – $400 USD per round" },
  ...
  courses: [
    { tier: "resort",  verified: true, fee: "$325 – $400", name: "Pacifico Course",          difficulty: "4/5", bestFor: "The Tail of the Whale · ocean holes",  specs: "Jack Nicklaus · Par 72 · 7,014 yards · 1999", photos: ["/images/jdd69nak-punta-mita-drone.webp"], photoSource: "Riviera Nayarit Field Photography",  note: "380 acres of peninsula. Eight holes on the Pacific. The course features an optional island green — the Tail of the Whale (hole 3B) — reachable by boat at low tide only. It is the only natural island green in golf. Ask the pro shop the night before for the tide window. If your tee time falls inside it, go. If not, play 3A. The round holds either way. Caddie included from the shuttle to the final putt. Resort access only — Four Seasons, St. Regis, private residences.", standout: "3B — nothing else like it in golf." },
    { tier: "resort",  verified: true, fee: "$325 – $400", name: "Bahia Course",             difficulty: "3/5", bestFor: "Ocean-carry par 5 finish",            specs: "Jack Nicklaus · Par 72 · 2005", photos: ["/images/uibfbgsu-punta-mita.webp"], photoSource: "Riviera Nayarit Field Photography",               note: "Same peninsula. Caddie included. More forgiving off the tee. Bahia moves through tropical jungle before finding the ocean on the closing holes. The last shot of the round is a forced carry over water — the only ocean-carry par 5 in Mexico. You make the decision before you take the club back. Resort access only — Four Seasons, St. Regis, private residences.",                                                                                                                                                                  standout: "#18 — commit or lay up. The round ends with a choice." },
  ...
  faqs: [
    ...
    { q: "How much does it cost to play golf in Punta Mita?", a: "Pacifico and Bahia run $325–$400 USD all-in per round for resort guests, including 16% tax and 10% service charge — the club publishes USD 250–320 before those are added. Higuera Golf Club is $150–$285 USD rack rate, with packages available around $180 per round. Mandarina requires contacting the resort directly for current rates." },
    ...
    { q: "Is Punta Mita the best golf destination in Riviera Nayarit?", a: "Yes — by every objective measure. Punta Mita holds two of the four Jack Nicklaus Signature courses in the entire Riviera Nayarit corridor, anchors the only stretch with Four Seasons, St. Regis, and (by 2027) Montage and Pendry brands operating in tandem, and is the closest premier golf destination to Puerto Vallarta International (PVR) at 45 minutes. Mandarina and Nauka extend the corridor to the north for variety, but Punta Mita is where the density of championship golf, hotel access, and infrastructure concentrates. For first-time visitors planning a Riviera Nayarit golf trip, Punta Mita is the right anchor." },
