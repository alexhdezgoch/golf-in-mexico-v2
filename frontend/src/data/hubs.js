...
const LOS_CABOS = {
  ...
  courses: [
    ...
    { tier: "private", verified: true, fee: "$315 – $385", name: "Cove Club at Cabo del Sol",    difficulty: "4/5", bestFor: "Iconic back nine, sea views",   specs: "Jack Nicklaus · Par 72 · Championship",                  note: "The course that put Los Cabos on the global golf map. Reopened in 2019 as the Cove Club with redesigned holes by Nicklaus, including a new par-3 17th that drops to a green backdropped by the sea. Golf Digest World Top 100.",                                                                                                                                                                                                                            standout: "#18 — Peninsula-style green that appears to float on the ocean. The previous par-4 16th, remodeled as the closing hole, plunges 100 feet down the side of a mountain." },
    { tier: "private", verified: true, fee: "$320 (taxes incl.)", name: "Diamante — Dunes Course",       difficulty: "3/5", bestFor: "Links experience, dunes",       specs: "Davis Love III · Par 72 · Championship",                 note: "A true links experience framed by massive white sand dunes on the Pacific side of Cabo San Lucas. Walks and plays like a classic British course — with 340 days of sunshine. Ranked #1 golf course in Mexico by Golf Digest. World Top 100. The standard by which all Cabo courses are measured.",                                                                                                                                                                                                                                                                                                                                                                       standout: "#17 — Par 3 with target semi-obscured by sand and scrub. The 590-yard par-5 18th plays to a shelf green perched 50 feet above the fairway." },
...
const PUNTA_MITA = {
  ...
  courses: [
    { tier: "resort",  verified: true, fee: "$345 – $395", name: "Pacifico Course",          difficulty: "4/5", bestFor: "The Tail of the Whale · ocean holes",  specs: "Jack Nicklaus · Par 72 · 7,014 yards · 1999",  note: "380 acres of peninsula. Eight holes on the Pacific. One island green in the middle of the ocean. The 3B optional — Tail of the Whale — is reachable by boat at low tide only. It is the only natural island green in golf. Ask the pro shop the night before for the tide window. If your tee time falls inside it, go. If not, play 3A. The round holds either way. Caddie included from the shuttle to the final putt. Resort access only — Four Seasons, St. Regis, private residences.", standout: "3B — nothing else like it in golf." },
    ...
    { tier: "public",  verified: true, fee: "$250 – $280", name: "Mandarina Golf Club",      difficulty: "3/5", bestFor: "Short-course concept · no key needed", specs: "Greg Norman · 9 par 3s + 1 challenge hole",    note: "Not a full 18. Nine par 3s, each with a name and a concept: The Redan, The Devil's Hole, The Queen, The Theater, The Bell. Plus one challenge hole — The Kraken — a near-island green with a pot bunker as the only escape. Norman: \"El campo de Mandarina no tendrá parangón.\" Fee includes two rounds of 10 holes, cart with GPS, unlimited practice, and all food and beverages. No membership required. Transportation to the property needed from outside the Mandarina community.",                                       standout: "The Theater — Norman described it as one of the best medium-distance par 3s in the world." },
