...
const LOS_CABOS = {
  ...
  heroPhoto: "/images/0wyp4brb-cabo-photo.webp",
  heroSlider: [
    "/images/d3b1vfc5-gim-stills-36.webp",
    "/images/mmtjphx0-gim-stills-33.webp",
  ...
  overviewParagraphs: [
    "Los Cabos golf spans 18 active championship courses — with 5 more under construction — along a dramatic 20-mile stretch where the Sonoran Desert meets the Sea of Cortez. Where the mountains clash directly with the shoreline, signature architects have carved out a paradise shaped by Nicklaus, Woods, Norman, Love III, and Fazio. The region moved over 329,500 air passengers in January 2025 alone and commands incredible loyalty among luxury travelers, posting an elite 38% repeat-visitor rate.",
    "The market splits into three distinct zones. San José del Cabo operates at a peaceful 63% hotel occupancy, offering a cultural backdrop. Cabo San Lucas runs hotter at 79% occupancy, centered around the marina and active nightlife. The real center of gravity for championship golf is The Tourist Corridor — this exclusive strip commands a luxury-segment average nightly rate of $795 USD and hosts the vast majority of top-tier tracks.",
    "Eighteen courses span the corridor, with more opening by 2026. Eight of the top layouts were shaped by Nicklaus, Woods, Norman, Love III, and Fazio — including three courses by Nicklaus alone. The terrain is the differentiator: Pacific cliffside holes at Quivira, links-style dunes at Diamante, desert arroyos at Club Campestre, coastal finishes at Puerto Los Cabos. No other Los Cabos golf destination puts this variety inside a 20-mile stretch. With three courses on Golf Digest's World 100 Greatest list and seven of Mexico's top 10 as ranked by Golf Digest, Los Cabos is the undisputed golf capital of Latin America.",
  ],
  overviewStats: [
    { num: "329,500", label: "Air passengers Jan 2025" },
    { num: "38%",     label: "Repeat visitors" },
    { num: "$795",    label: "Avg. Nightly Rate — Luxury Corridor" },
    { num: "18",      label: "Active courses" },
  ],
  ...
  coursesIntro: "From Nicklaus to Tiger Woods to Fazio — the complete field guide to our curated picks from the 18 active courses in Los Cabos, with editorial difficulty ratings and access notes.",
  courses: [
  ...
  logistics: [
    { icon: "plane",    title: "Airport + arrivals",   body: "Los Cabos International Airport (SJD) handles 82.9% of US traffic — Los Angeles (12.5%), Dallas (10.7%), Phoenix (10.5%). SJD handled 2,000+ private operations in January 2025 with its own dedicated FBO terminal. Several Corridor resorts arrange direct tarmac-to-villa transfers." },
  ...
  faqs: [
    ...
    { q: "What are the best golf courses in Cabo San Lucas?", a: "Within Cabo San Lucas itself, Quivira Golf Club (Jack Nicklaus) leads on visual drama — every hole has a Pacific view and the 13th par-3 sits 150 feet above the ocean. Solmar Golf Links (Greg Norman) delivers a genuine links experience with revetted pot bunkers — the only ones in Mexico. Diamante's Dunes Course (Davis Love III), 15 minutes north of downtown Cabo San Lucas, is ranked No. 1 in Mexico by Golf Digest and El Cardonal (Tiger Woods) hosts the PGA Tour World Wide Technology Championship. Together these four define Cabo San Lucas golf at the top tier." },
    { q: "How do I get access to private golf courses in Los Cabos?", a: "Private access here works on two routes: stay at the right hotel, or know the right member. Cove Club at Cabo del Sol opens to Solaz, a Luxury Collection Resort guests. Twin Dolphin requires a Montage Los Cabos reservation. Chileno Bay is exclusive to Auberge Chileno Bay guests. El Dorado is members and member-sponsored guests only — no public route. Quivira opens to Pueblo Bonito Oceanfront guests. The fastest way in is to book the matching resort. GIM coordinates the resort + tee time as a package — that is the entire model." },
...
const PUNTA_MITA = {
  ...
  heroPhoto: null,
  heroSlider: [
    "/images/jdd69nak-punta-mita-drone.webp",
    "/images/uibfbgsu-punta-mita.webp",
    "/images/iwvp4z04-mandarina-course.webp",
    "/images/b3h22ocy-mandarina-bunker.webp",
    "/images/jkdh05kp-mandarina-drone.webp",
  ],
  ...
  heroAnswer:
    "Punta Mita's two headline courses — Pacifico and Bahia, both Jack Nicklaus Signature — sit inside a private peninsula and require a Four Seasons stay, a St. Regis stay, a qualifying villa, or ownership. Two more courses, Higuera (Greg Norman) and Mandarina, are open to the public. In all, five championship courses sit within a 75-kilometer corridor north of Puerto Vallarta International (PVR), with designs by Nicklaus, Norman, and Tom Fazio. Green fees run $150 to $395 per round.",
  ...
  overviewParagraphs: [
    ...
    "Punta Mita anchors the corridor. The 1,500-acre private peninsula 45 minutes north of Puerto Vallarta International (PVR) holds two Jack Nicklaus Signature courses — Pacifico and Bahia — both restricted to Four Seasons and St. Regis guests, villa renters, and property owners. Pacifico features an optional island green — the Tail of the Whale (hole 3B) — reachable by boat at low tide only. It is the only natural island green in golf and the single most photographed hole in Mexico.",
  ...
  coursesIntro: "Five courses on a 75-km corridor. One round: play Pacifico for the ocean holes and the Tail of the Whale. Want public access with no room key: Higuera Golf Club. A quick, all-inclusive nine par-3s: Mandarina. Members only: Nauka (Tom Fazio, 2025). Bahia is the forgiving second peninsula round.",
  courses: [
    { tier: "resort",  verified: true, fee: "$345 – $395", name: "Pacifico Course",          difficulty: "4/5", bestFor: "The Tail of the Whale · ocean holes",  specs: "Jack Nicklaus · Par 72 · 7,014 yards · 1999", photos: ["/images/jdd69nak-punta-mita-drone.webp"], photoSource: "Riviera Nayarit Field Photography",  note: "380 acres of peninsula. Eight holes on the Pacific. The course features an optional island green — the Tail of the Whale (hole 3B) — reachable by boat at low tide only. It is the only natural island green in golf. Ask the pro shop the night before for the tide window. If your tee time falls inside it, go. If not, play 3A. The round holds either way. Caddie included from the shuttle to the final putt. Resort access only — Four Seasons, St. Regis, private residences.", standout: "3B — nothing else like it in golf." },
    { tier: "resort",  verified: true, fee: "$325 – $375", name: "Bahia Course",             difficulty: "3/5", bestFor: "Ocean-carry par 5 finish",            specs: "Jack Nicklaus · Par 72 · 2005", photos: ["/images/uibfbgsu-punta-mita.webp"], photoSource: "Riviera Nayarit Field Photography",               note: "Same peninsula. Caddie included. More forgiving off the tee. Bahia moves through tropical jungle before finding the ocean on the closing holes. The last shot of the round is a forced carry over water — the only ocean-carry par 5 in Mexico. You make the decision before you take the club back. Resort access only — Four Seasons, St. Regis, private residences.",                                                                                                                                                                  standout: "#18 — commit or lay up. The round ends with a choice." },
    { tier: "public",  verified: true, fee: "$250 – $280", name: "Mandarina Golf Club",      difficulty: "3/5", bestFor: "Short-course concept · no key needed", specs: "Greg Norman · 9 par 3s + 1 challenge hole", photos: ["/images/iwvp4z04-mandarina-course.webp"], photoSource: "Riviera Nayarit Field Photography",    note: "Not a full 18. Nine par 3s, each with a name and a concept: The Redan, The Devil's Hole, The Queen, The Theater, The Bell. Plus one challenge hole — The Kraken — a near-island green with a pot bunker as the only escape. Norman: \"El campo de Mandarina no tendrá parangón.\" (\"Mandarina will have no equal.\") Fee includes two rounds of 10 holes, cart with GPS, unlimited practice, and all food and beverages. No membership required. Transportation to the property needed from outside the Mandarina community.",                                       standout: "The Theater — Norman described it as one of the best medium-distance par 3s in the world." },
  ...
  costsH2Pre: "Here is exactly",
  costsH2Em: "what you will spend.",
  costsIntro: "Green fees run $150–$395 per round. Inside the peninsula, Pacifico and Bahia are caddie-included and resort-access only; public Higuera is the value entry at $150–$285. But the hotel — not the golf — is the real cost here: a night at Siari or One&Only can exceed three combined green fees.",
  costs: [
  ...
  faqs: [
    { q: "Is Punta Mita golf open to the public?", a: "Partly. Pacifico and Bahia — the two Jack Nicklaus Signature courses inside the peninsula — are restricted to Four Seasons and St. Regis guests, villa renters, and property owners. Higuera Golf Club (Greg Norman) and Mandarina Golf Club take public bookings with no resort affiliation required." },
    { q: "Can I play if I stay at the Four Seasons or St. Regis Punta Mita?", a: "Yes. A confirmed stay at Four Seasons Punta Mita or St. Regis Punta Mita is one route onto Pacifico and Bahia, and the pro shop books your tee time once your stay is confirmed. Caddies are included at Four Seasons. Punta Mita villa renters and property owners also qualify for access to both courses." },
    { q: "How do I book a Punta Mita golf tee time?", a: "Book through the resort pro shop once your access — a resort stay, villa, or ownership — is confirmed. Pacifico tee times fill six to nine months ahead in peak season (December through March), so reserve your room and rounds together, never separately." },
    { q: "How much does it cost to play golf in Punta Mita?", a: "Green fees run $150–$395 per round. Pacifico is $345–$395 and Bahia $325–$375 (caddie included, resort access only); public Higuera Golf Club is $150–$285; Mandarina is $250–$280 including two 10-hole rounds, a GPS cart, and food and beverages. Rates current to 2026." },
    { q: "What is the Tail of the Whale?", a: "Hole 3B on Pacifico — billed as the only natural island green in golf, a par-3 played to a green on a rock in the Pacific. It is optional and playable at low tide only. Ask the pro shop the night before for the tide window; if your tee time falls inside it, play it." },
    { q: "Which Punta Mita course should I play — Pacifico or Bahia?", a: "If you have one round, play Pacifico: eight holes along the Pacific and the Tail of the Whale. Bahia, also Jack Nicklaus, is more forgiving off the tee and runs through jungle to an ocean-carry par-5 finish — the only one in Mexico. Both sit inside the private peninsula." },
    { q: "Do I need a golf cart or rental clubs at Punta Mita?", a: "Carts are standard and often bundled — Mandarina's fee includes a GPS cart. Budget rental clubs separately: TaylorMade sets are available at the peninsula pro shops, roughly $0–$150 depending on course. Confirm exactly what your green fee includes when you book." },
    { q: "When is the best time to golf in Punta Mita?", a: "November through May — warm, dry days at 75–85°F. December to March is peak: best weather, humpback whales in Banderas Bay visible from the fairways, and the tightest tee sheets. April is the value sweet spot. Avoid August through October (rain and hurricane window)." },
...
const MEXICO_CITY = {
  ...
  overviewParagraphs: [
    ...
    "The circuit beyond the city is equally strong. Amanali in Hidalgo — Schmidt & Curley, 7,400 yards, canyons and lake views — is considered one of the 10 best courses in Mexico. Avandaro sits inside a resort in Valle de Bravo, 90 minutes from the city, where the pine forest is the differentiator. Tabachines in Cuernavaca is 45 minutes from the city in a microclimate that stays green year-round. Our approach: coordinate access in advance, play the history at Chapultepec, escape to the mountains for the contrast.",
  ],
  overviewStats: [
  ...
  courses: [
    { tier: "private", verified: true, fee: "Invitation only", name: "Club de Golf México",       difficulty: "5/5", bestFor: "Mexico's most historic private club",  specs: "Percy Clifford (1947) · Par 72 · 18 holes · Tlalpan, CDMX", photos: ["/images/3npawpvw-screenshot-2026-06-10-at-1-53-50-p-m.webp"], note: "The most prestigious private club in Mexico. Founded in 1947 in the Tlalpan corridor of southern CDMX, the course was designed by Percy Clifford — the architect responsible for shaping a generation of Mexican golf. Tight tree-lined fairways at 2,260 meters above sea level, with downtown Mexico City visible from multiple elevated tees. Hosted the World Cup of Golf in 1958 and 1968. Member invitation only; no public tee times. The dress code, the caddie program, and the clubhouse protocol set the standard the rest of the country still measures itself against.", standout: "Elevated tees with the CDMX skyline framing the fairway — the most photographed view in Mexican golf." },
    { tier: "private", verified: true, fee: "Invitation only", name: "Club de Golf Chapultepec",   difficulty: "5/5", bestFor: "WGC + LIV + Mexican Open host", specs: "Willie & Alex Smith (1921) · Percy Clifford redesign (1972) · Par 71 · 7,345 yards", photos: ["/images/e60z74y2-golf-in-mexico-5.webp"], note: "The most historically important golf course in Mexico. Designed in 1921 by U.S. Open champion Willie Smith and completed by his brother Alex; redesigned by Percy Clifford in 1972. Mexican Open host 18 times, WGC-Mexico Championship 4 times (2017–2020), LIV Golf Mexico City in 2025 and 2026. At 7,800 feet above sea level, tight tree-lined fairways and undulating terrain make club selection a constant negotiation. The uphill trio of holes 15–17 is among the most demanding closing stretches in Mexican golf. Greens are small, very fast, severely sloped. Local knowledge is the differentiator. Member invitation only. No public tee times.", standout: "#17 — par 3, 167 yards. Water front and left. A miss left costs a number." },
    { tier: "private", verified: true, fee: "$5,100 – $7,000 MXN", name: "Bosque Real Country Club", difficulty: "4/5", bestFor: "Longest course in Mexico",  specs: "Robert von Hagge, Smelek & Baril (2002) + Gary Nicklaus 9-hole executive (2008) · Par 72 · 7,552 yards", photos: ["/images/e60z74y2-golf-in-mexico-5.webp"], note: "One of the longest courses in Mexico at 7,552 yards — and at altitude, every yard plays significantly easier than on the card thanks to the thinner air. Translated to sea level, this would be a brutal championship layout closer to 8,400 yards. Von Hagge's 18-hole design winds through mountain terrain with a river, canyons, ponds, and multiple lakes. Earned the LPGA MasterCard Classic from 2005 to 2009. Lorena Ochoa played here. Louise Friberg holds the women's course record at 65. A 9-hole executive course by Gary Nicklaus opened in 2008 alongside the championship layout. 15 km west of CDMX in Huixquilucan — 20 minutes from Santa Fe on a clear day. Some public booking available on weekdays with advance coordination.", standout: "#18 — par 5, 624 yards from the tips. The longest hole on the course." },
    { tier: "resort",  verified: true, fee: "Advance booking", name: "Amanali Country Club",      difficulty: "4/5", bestFor: "Best day-trip course from CDMX", specs: "Schmidt & Curley (2010) · Par 72 · 7,400 yards · Tepeji del Río, Hidalgo", photos: ["/images/e60z74y2-golf-in-mexico-5.webp"], note: "Considered one of the 10 best courses in Mexico. Schmidt & Curley designed the layout on the banks of a lake in Tepeji del Río — zigzagging through canyons and cactus with panoramic lake views from most holes. Bermuda fairways, Bent Grass greens, 7,400 yards that would play closer to 8,200 at sea level once the altitude advantage is removed. A resort development surrounds the course, with the clubhouse designed by Legorreta Arquitectos. 50 minutes from Polanco — the best day-trip course in the CDMX corridor for golfers without a local membership.", standout: "Canyon and lake routing — no two holes share the same terrain type. The back nine plays harder than the front." },
    { tier: "private", verified: true, fee: "$3,000 – $4,500 MXN", name: "Encinos Golf Club",       difficulty: "3/5", bestFor: "Tournament course · oak corridor", specs: "Joe Finger (1990) · Par 72 · 7,099 yards · Lerma, Estado de México", photos: ["/images/e60z74y2-golf-in-mexico-5.webp"], note: "Host of the European Challenge Tour (Los Encinos Open, 2002–2007). A tournament course the public almost never gets to play. Joe Finger's 1990 design is well-integrated into a landscape of oak trees and native vegetation. Fast greens — among the most difficult to read among Mexico City golf courses. The back nine is significantly more demanding than the front. Caddies mandatory, paid at the course. At 2,500 meters above sea level — higher than Chapultepec — the altitude effect is maximized. Members and guests only.", standout: "Back nine greens — the #11 green is consistently cited as the most difficult on the course." },
  ...
  faqs: [
    ...
    { q: "Is Club de Golf Chapultepec open to visitors?", a: "Not directly. Club de Golf Chapultepec is a private club in Naucalpan, Estado de México, 20 minutes from Polanco, with access by member invitation only — there is no public booking, hotel resort affiliation, or day-pass route. Mexico's most historically significant course, designed in 1921 by U.S. Open champions Willie and Alex Smith, redesigned by Percy Clifford in 1972. Par 71, 7,345 yards, at 7,800 feet above sea level. Host of the Mexican Open 18 times, WGC-Mexico Championship 4 times, and LIV Golf Mexico City in 2025 and 2026. Visitors gain access only through a member contact. GIM coordinates introductions where possible." },
...
const CANCUN = {
  ...
  overviewParagraphs: [
    "Cancun International is the most-served Mexican airport by US carriers — direct flights from 25+ US cities, customs that moves efficiently, and Highway 307 running the full length of the Riviera Maya golf corridor south to Tulum. For visiting golfers, this is the lowest-friction trip in the country.",
    "The Riviera Maya golf corridor organizes into three zones. North Cancun has Playa Mujeres (Greg Norman, 27 holes, Caribbean and lagoon views) and the Hotel Zone cluster — Iberostar, Moon Palace, Puerto Cancun. The Mayakoba node, 50 minutes from CUN, is the standout destination in the corridor: El Camaleón hosted the PGA Tour Mayakoba Golf Classic from 2007 to 2022. South of the airport, Riviera Cancun Golf Club (Jack Nicklaus) and El Tinto (Nick Price) sit on the same property — two separate championship layouts. South of Playa del Carmen, Gran Coyote (Nick Price) and PGA Riviera Maya (RTJ Jr., Korn Ferry 2025) anchor the Tulum end.",
    "The terrain is Caribbean resort golf — not desert, not cliff. Mangrove crossings, limestone cenote features, jungle corridors, and the occasional Mayan ruin on the 16th hole (Iberostar). The differentiator here is the variety of access models: all-inclusive bundles at Moon Palace, public tee times at Puerto Cancun, the tournament experience at El Camaleón. Three designers define the corridor: Greg Norman at Playa Mujeres and El Camaleón. Jack Nicklaus at Moon Palace and Riviera Cancun Golf Club. Nick Price at El Tinto and Gran Coyote.",
  ],
  overviewStats: [
...
const PUERTO_VALLARTA = {
  ...
  heroSlider: [
    ...
    "/images/6ntevszb-5573a261-fa98-47f9-9cb4-afc720500ad7-1-105-c.webp",
  ],
  ...
  faqs: [
    ...
    { q: "Are the golf courses in Puerto Vallarta walkable?", a: "Most courses are cart-mandatory due to terrain — Vista Vallarta climbs significant elevation, El Tigre stretches across a property with long transitions between holes, and Vidanta Norman includes a 560-foot cart suspension bridge over the Ameca River. Marina Vallarta and Flamingos are flatter and theoretically walkable, but caddies and carts are the local standard and green fees typically include cart rental. Bring shoes that work for both walking the city in the afternoon and 18 holes in the morning — Puerto Vallarta does both in one day." },
