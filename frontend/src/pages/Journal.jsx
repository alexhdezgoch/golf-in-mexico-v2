...
const MUST_READS = [
  ...
  },
  {
    ...
    excerpt: "A decade across tour environments, locker rooms, and pro-ams — what it taught us.",
  ...
  },
  {
    ...
    excerpt: "Why we don't sell from a catalogue — and the houses, clubs, and hotels we actually trust.",
  ...
  },
  {
    ...
    excerpt: "Tee times, transfers, courses, and conversations — the playbook for a frictionless week.",
  ...
  },
  {
    ...
    excerpt: "What 'luxury' actually buys you here — and the rooms, rounds, and tables that earn the word.",
  ...
  },
  {
    ...
    excerpt: "Diamante's Dunes at dawn, Quivira at the cliff, El Camaleón at the marina, Cabo del Sol at sunset.",
    image: "https://images.unsplash.com/photo-1605144156546-91acf5e4cffd?auto=format&fit=crop&w=1200&q=85",
    pillar: "Region Guides",
    author: "Pablo De La Mora",
    read: "12 min",
  ...
  },
  {
    ...
    excerpt: "Paspalum holds the ball where bermuda releases it. What your wedge actually has to do.",
    image: "https://images.unsplash.com/photo-1535132011086-b8818f016104?auto=format&fit=crop&w=1200&q=85",
    pillar: "Golf & Nature",
    author: "José Islas",
    read: "6 min",
  },
  {
    ...
    excerpt: "The 2023 U.S. Amateur quarterfinal, from a Mexican kid's perspective.",
  ...
  },
  {
    ...
    excerpt: "Booking premium golf in México — what you actually need: introductions, not allotments.",
    image: "https://images.unsplash.com/photo-1543105177-748ceda71741?auto=format&fit=crop&w=1200&q=85",
    pillar: "Region Guides",
    author: "Pablo De La Mora",
    read: "7 min",
  },
  {
    ...
    title: "The best table after eighteen holes in CDMX.",
    excerpt: "Where the round ends, the city begins — five tables that are worth the cab.",
  ...
  },
  {
    ...
    excerpt: "Nicklaus's island green, the Pacific against the rocks — the round that puts everything in scale.",
      ...
      <div className="col-span-12 md:col-span-9">
        ...
        >
          ...
          <p>
            ...
            Baja desert to the Caribbean. Today, top courses span three coasts
            and a volcanic plateau, surpassing Canada, Argentina, and most of
            the U.S. Sun Belt.
          </p>
          <p>
            Luxury golf vacations in México combine rounds with oceanfront
            suites and the finest Latin American cuisine. All-inclusive
            packages offer unlimited golf at nightly rates, often closing the
            price gap with Arizona or Florida.
          </p>
          <p>
            ...
            level to seven thousand feet. Editorial voice, first-person field
            notes, and access rules that concierge services often overlook.
          </p>
        </motion.div>
      </div>
    </div>
        ...
        {REGIONS.map((r, i) => {
          ...
          return (
            <motion.li
              ...
              className="col-span-12 sm:col-span-6 lg:col-span-[2.4] group"
              style={{ flexBasis: "20%" }}
            >
              <Tag {...props} className="block">
                <div className="relative aspect-[3/4] w-full overflow-hidden bg-ink">
                  ...
                  <span className="absolute top-3 right-3 font-mono text-[9px] uppercase tracking-wide-editorial text-cream bg-ink/55 backdrop-blur-sm px-2 py-1">
                    {r.courses} Courses
                  </span>
                </div>
                <div className="mt-4">
                  ...
                  <h3 className="mt-1 font-display font-light text-ink text-xl md:text-2xl leading-[1.1] tracking-tight">
                    {r.name}
                  </h3>
                  <p className="mt-1.5 font-display italic font-light text-ink/65 text-sm leading-[1.3]">
                    {r.tagline}
                  </p>
                </div>
              </Tag>
    ...
    >
      <Tag {...props} className="block">
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-ink">
          ...
          {a.pinned && (
            <span className="absolute top-3 right-3 font-mono text-[9px] uppercase tracking-wide-editorial text-cream bg-gold px-2 py-1">
              Must read
            </span>
          )}
          {!a.live && !a.pinned && (
        ...
        <div className="mt-5">
          <h3
            className={`font-display font-light leading-[1.1] tracking-tight text-xl md:text-2xl max-w-[22ch] ${
...
const MustReads = () => {
  ...
  const onChangePillar = (p) => {
    setPillar(p);
    setShown(PAGE_SIZE);
    setPillarOpen(false);
  };
  const onChangeAuthor = (a) => {
    setAuthor(a);
    setShown(PAGE_SIZE);
    setAuthorOpen(false);
  };
              ...
              <AnimatePresence>
                {pillarOpen && (
                  <motion.ul
                    ...
                    data-testid="dropdown-pillar-menu"
                  >
                    {PILLARS.map((p) => (
                      <li key={p}>
                        <button
              ...
              <AnimatePresence>
                {authorOpen && (
                  <motion.ul
                    ...
                    transition={{ duration: 0.2 }}
                    className="absolute z-20 right-0 mt-1 min-w-[220px] bg-cream border border-ink/20 shadow-lg"
                    data-testid="dropdown-author-menu"
                  >
                    {AUTHORS.map((a) => (
                      <li key={a}>
                        <button
